    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        function scrollPage(destination, animated) {
           ...
           //#oblaka
           //$('#oblaka').css('-webkit-transform','translate3d(10%, 0px, 0px)');               
           $('#oblaka').css('background-position-x',  (v.sectionIndex*20)+'%' );
            ...
            if (v.yMovement === 'down') {
                ...
                $(v.destination).css('opacity',1);

                   $(v.activeSection).css('-webkit-transform','translate3d(-100%, 0px, 0px)');               
                   $(v.activeSection).css('-moz-transform','translate3d(-100%, 0px, 0px)');
                   $(v.activeSection).css('-o-transform','translate3d(-100%, 0px, 0px)');
                   $(v.activeSection).css('transform','translate3d(-100%, 0px, 0px)');

                   $(v.destination).css('-webkit-transform','translate3d(0px, 0px, 0px)');
                   $(v.destination).css('-moz-transform','translate3d(0px, 0px, 0px)');
                   $(v.destination).css('-o-transform','translate3d(0px, 0px, 0px)');
                   $(v.destination).css('transform','translate3d(0px, 0px, 0px)');



                   //alert(v.leavingSection+" = "+v.sectionIndex);
                    if(v.leavingSection < v.sectionIndex)
                    {
                        for(var i=v.leavingSection+1; i<=v.sectionIndex; i++)
                        {  
                           // alert(i);
                           $("#section"+i).css('opacity',1);
                           $("#section"+i).css('-webkit-transform','translate3d(-100%, 0px, 0px)');
                           $("#section"+i).css('-moz-transform','translate3d(-100%, 0px, 0px)');
                           $("#section"+i).css('-o-transform','translate3d(-100%, 0px, 0px)');
                           $("#section"+i).css('transform','translate3d(-100%, 0px, 0px)');
                        }
                    }
            ...
            //scrolling up (moving section down to the viewport)
               ...
               $(v.destination).css('transform','translate3d(0px, 0px, 0px)');    
                //v.translate3d = 'translate3d(0px, 0px, 0px)';
                 ...
                 if(v.leavingSection > v.sectionIndex)
                    {
                        for(var i=v.sectionIndex+2; i<v.leavingSection; i++)
                        {                       
                           $("#section"+i).css('opacity',1);
                           $("#section"+i).css('-webkit-transform','translate3d(100%, 0px, 0px)');
                           $("#section"+i).css('-moz-transform','translate3d(100%, 0px, 0px)');
